...
public class HttpUtil {
  ...
  public String postOrPut(String url, Object payloadData, Map<String, String> headers,
    ...
    try {
      ...
      throw new CMSAdminException(String.format("Error while making request to url : %s", url));
    }
    ...
    if (response == null) {
      ...
      throw new CMSAdminException(String.format("No response obtained for url request : %s ", url));
    }
  ...
  private String parseHttpResponse(HttpResponse response, String url) {
    ...
    try (BufferedReader reader =
      ...
      throw new CMSAdminException("Error while parsing response for URL : " + url, e);
    }
